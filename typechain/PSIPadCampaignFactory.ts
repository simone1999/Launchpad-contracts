...
export interface PSIPadCampaignFactoryInterface extends ethers.utils.Interface {
  functions: {
...
export interface PSIPadCampaignFactory extends BaseContract {
  ...
  interface: PSIPadCampaignFactoryInterface;
  ...
  functions: {
    ...
    campaigns(arg0: BigNumberish, overrides?: CallOverrides): Promise<[string]>;
