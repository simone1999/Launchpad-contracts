...
export interface IPSIPadCampaignInterface extends ethers.utils.Interface {
  functions: {
...
export interface IPSIPadCampaign extends BaseContract {
  ...
  interface: IPSIPadCampaignInterface;
  ...
  whitelisted(_address: string, overrides?: CallOverrides): Promise<boolean>;
