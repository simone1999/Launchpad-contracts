...
export interface AnyswapV4ERC20Interface extends ethers.utils.Interface {
  functions: {
...
export interface AnyswapV4ERC20 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: AnyswapV4ERC20Interface;
